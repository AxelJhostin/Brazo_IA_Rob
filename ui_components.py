...
def crear_panel_lateral(ancho, alto, angulos, mano_estable, conexion_serial, modo_actual, tiempo_restante=0):
    ...
    if modo_actual == config.MODO_CONFIGURACION:
        ...
        cv2.rectangle(panel, (20, 70), (ancho - 20, 130), (128, 0, 128), -1) # Color Púrpura
